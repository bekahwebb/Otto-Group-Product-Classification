...
#trees tree_depth learn_rate .config            
#<int>      <int>      <dbl> <chr>              
#  1   667          5        0.1 Preprocessor1_Mode…
#> 
...
#trying mn_log_loss 3x3 grid start time 7:12p fc finished at 8:44p got .56871 try 4x4 around 9 p finished around 12:30 a oh my gosh I got it! 0.47655, yay!
#wanting to get best_tune results, started at 11:13p